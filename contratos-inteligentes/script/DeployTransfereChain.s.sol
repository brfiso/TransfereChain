...
contract DeployTransfereChain is Script {
    function run() external returns (TransfereChain) {
        ...
        bancoRecebedor.enableAccount(0x45f2cB0F09AB00A4c62e7EC38487c464Ea59833E);
        vm.stopBroadcast();
        uint256 adminKey = vm.envUint('ADMIN_KEY');
        vm.startBroadcast(adminKey);
        // realDigital.grantRole(0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6, 0x65A711ae4B00b49A25528FE4883054080BC80F6D);
        bancoRecebedor.grantRole(0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6, address(transfereChain));
        realDigital.grantRole(0xe5ed70e23144309ce456cb48bf5e6d0d8e160f094a6d65ecf1d5b03cf292d8e6, address(transfereChain));
        vm.stopBroadcast();
        vm.startBroadcast(deployerPrivateKey);
        transfereChain.RegistraBeneficiario(123, 0x45f2cB0F09AB00A4c62e7EC38487c464Ea59833E, 'Marcelo', 'Pocos de Caldas', 12, 32, 434);
        transfereChain.RegistraParlamentar(21, 0xA104505CCeddC6aBD75d713A6af5a868CF82337f, 'Tiririca');
        vm.stopBroadcast();
        vm.startBroadcast(adminKey);
        transfereChain.AprovaTransferencia(1, 1000, 'Compra de material escolar', 0x65A711ae4B00b49A25528FE4883054080BC80F6D, 0x45f2cB0F09AB00A4c62e7EC38487c464Ea59833E);
        vm.stopBroadcast();
